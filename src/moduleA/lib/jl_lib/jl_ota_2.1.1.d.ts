...
export { FileOffset, IOTAOp, OTAConfig, OTAError, OTAImpl, OnResultCallback, OnUpgradeCallback, RcspOTAManager, ReConnectMsg, UpgradeType, ab2hex, getErrorDesc, logd, loge, logi, logv, logw, setLogGrade, setLogger,Logger };
